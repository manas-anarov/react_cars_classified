                    ...
                    <Form onSubmit={this.handleSubmit} className="login-form">
                        ...
                        <FormItem>
                            {getFieldDecorator('confirm', {
                                ...
                                <Input onBlur={this.handleConfirmBlur} prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />} type="password" placeholder="Парольду кайталаныз" />
                            )}
                        </FormItem>
...
const WrappedAuth = Form.create()(ProfileSignup);
